...
- **Carga Concurrente Controlada:** Sube múltiples archivos y crea múltiples carpetas al mismo tiempo (procesando en lotes seguros de 5) para no saturar la memoria del navegador ni los servidores de AEM, reduciendo drásticamente los tiempos de espera.
