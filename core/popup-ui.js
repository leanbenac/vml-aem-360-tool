...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (!tooltipEl) {
    ...
    validationsSection.className = 'tooltip-validations-section';
    const validationsLabel = document.createElement('span');
    validationsLabel.className = 'tooltip-section-label';
    validationsLabel.textContent = 'Validation Rules:';
    const validationsList = document.createElement('ul');
    validationsList.id = 'tooltipValidations';
    validationsList.className = 'tooltip-validations-list';
    validationsSection.appendChild(validationsLabel);
    validationsSection.appendChild(validationsList);
    
    tooltipEl.appendChild(header);
    tooltipEl.appendChild(desc);
    tooltipEl.appendChild(validationsSection);
  ...
  function showTooltip(btn) {
    ...
    tooltipValidations.replaceChildren();
